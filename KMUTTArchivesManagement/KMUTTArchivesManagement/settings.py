"""
Django settings for KMUTTArchivesManagement project.
...
SECRET_KEY = '1a4b7oc275^8$=#9hvz+jhzdrpvlxc(r%t7eb7k1t4dtuv&4fc'
...
ROOT_URLCONF = 'KMUTTArchivesManagement.urls'
...
WSGI_APPLICATION = 'KMUTTArchivesManagement.wsgi.application'
